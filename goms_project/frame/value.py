...
class Udata:
    def __init__(self, num, id, schooltype, majorcate, age, intern, toeic, tosp, train, jobseek, cert, jobsearch, yrwish, wishhr, wishsalary, jobgradu, liveexp):
        self.num = num;
        self.id = id;
    ...
    def __str__(self):
        return str(self.num) + ' ' + self.id +' '+ str(self.schooltype)+\
               ...
               ' '+str(self.jobgradua)+' '+str(self.liveexp);
